...
1. Build or install the app (see [Install a pre-built bundle](#path-a--install-a-pre-built-bundle-easiest) or [Build from source](#path-b--build-from-source)).
